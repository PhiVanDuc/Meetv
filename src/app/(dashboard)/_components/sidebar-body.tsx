                                ...
                                return (
                                    <SidebarMenuItem key={item.href}>
                                        <SidebarMenuButton
                                            asChild
                                            size="lg"
                                            className="gap-[10px] [&_svg]:w-5 [&_svg]:h-5 text-zinc-500 font-medium hover:bg-linear-to-r hover:from-brand-primary/15 hover:to-brand-primary/5 hover:text-brand-primary cursor-pointer"
                                        >
                                            <Link href={item.href}>
                                                <item.icon/>
