...
export default function DashboardNavbar() {
    ...
    const {isOpenCommand, setIsOpenCommand, handleOpenCommand, stateSidebar, toggleSidebar} = useDashboardNavbar()
    ...
    return (
        <>
            ...
            <nav className="flex items-center gap-[10px] p-[15px] border-b">
                <Button
                    variant="outline"
