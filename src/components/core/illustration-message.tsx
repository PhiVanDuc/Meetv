...
export default function IllustrationMessage({title, description}: Props) {
    return (
        <div className="space-y-[60px]">
            <div className="flex flex-col gap-[5px] items-center w-full">
                ...
                <div className="flex items-stretch gap-[15px] p-[15px] w-full max-w-[320px] bg-white border rounded-[10px]">
                    ...
                    <div className="self-stretch flex flex-col justify-between py-[5px] w-full">
                        <span className="inline-block w-full md:w-[50%] h-[8px] bg-orange-600 rounded-full" />
            ...
            <div className="flex flex-col items-center gap-[10px]">
                <h3 className="header text-[20px]">{title}</h3>
                <p className="w-full max-w-[650px] desc text-center">{description}</p>
            </div>
        </div>
    )
}
